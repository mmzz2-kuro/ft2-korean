...
class BeHdrUiWorkflowGui(tk.Tk):
    def __init__(self):
        ...
        self.vars = {
            ...
            "translation": tk.StringVar(value=str(ROOT / "trDatas/be-hdr-ui-workflow/be-hdr-ui-translation.tsv")),
            ...
            "ids": tk.StringVar(value="811-828,1170-1185,1187,1189,1191-1217"),
